#!/bin/sh
# ABOUTME: Builds audiocraft against whatever ggml revision is checked out and
...
if [ "$backend" = cuda ]; then
    ...
    configure_extra="-DAC_CUDA=ON -DCMAKE_CUDA_ARCHITECTURES=75-virtual"
